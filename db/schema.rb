...
ActiveRecord::Schema.define(version: 2026_09_11_100000) do
  ...
  create_table "combat_combatants", force: :cascade do |t|
    ...
    t.jsonb "turn_state", default: {}, null: false
    t.integer "turn_state_rev", default: 0, null: false
  ...
  create_table "sheets", force: :cascade do |t|
    ...
    t.jsonb "training", default: {}, null: false
    t.jsonb "dm_proficiencies", default: {}, null: false
  ...
  create_table "validate_jwt_tokens", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["token"], name: "index_validate_jwt_tokens_on_token"
  end
